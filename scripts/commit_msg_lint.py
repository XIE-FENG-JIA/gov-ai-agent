...
_REJECT_PATTERNS = (
    ...
    re.compile(r"^chore\(auto-engineer\):\s*AUTO-RESCUE\b", re.IGNORECASE),   # 漂白第六型 admin rescue
    re.compile(r"^chore\(auto-engineer\):\s*\d+\s*files\b", re.IGNORECASE),   # 漂白第六型 bulk admin batch

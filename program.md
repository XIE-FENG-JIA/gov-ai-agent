...
- [x] **T-FAT-ROTATE-V2（刀 6）** ✅（2026-04-22）— 將 `src/cli/generate/export.py 414` 拆為 `export.py 240 + content_metadata.py 178`，把 metadata 注入與格式顯示邏輯抽成獨立模組，保留 `src.cli.generate` 既有匯入面；實測 `src/` 目前已無 `> 400` 行 Python 檔。
...
- [x] **近期閉環（2026-04-22）** — `T-PROGRAM-MD-ARCHIVE`、`T-PYTEST-PROFILE`、`T-ROLLUP-SYNC`、`T-FAT-ROTATE-V2` 刀 6、`T9.6-REOPEN-v4`、`T-FAT-ROTATE-V2` 刀 3/4/5、`T-BARE-EXCEPT-AUDIT` 刀 1/2、`P1-PCC-ADAPTER`、`P0.1-FDA-LIVE-DIAG`、`P0.3-CORPUS-SCALE`、`EPIC5-TASKS-SPECS`、`T5.1`、`T5.2`、`T5.3`、`T5.4`。

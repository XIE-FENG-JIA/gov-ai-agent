...
- [ ] **T-FAT-ROTATE-V2（刀 5+）** 🟡 **v6.2 P1（輪拆；連 2 輪延宕 = 3.25）** — 剩 **6** 胖檔 > 400：`middleware 470 / api-models 462 / generate/export 460 / fact_checker 447 / datagovtw 411 / workflow_cmd 407`；SOP 第 15/16/17/18/19/20 刀輪到哪刀哪；單輪只切 1 檔避免顆粒度漂移
...
- [ ] **T-FAT-ROTATE-V2（刀 5+）** 🔴 下輪再鎖 `middleware 470 / api-models 462 / generate/export 460 / fact_checker 447 / datagovtw 411 / workflow_cmd 407`

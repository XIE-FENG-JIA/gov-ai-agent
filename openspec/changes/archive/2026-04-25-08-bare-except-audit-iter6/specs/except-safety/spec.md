# Spec: Bare-Except Audit Iteration 6

## Summary

Sixth iteration of the bare-exception audit. Sweeps 6 files × 3 sites (18
total) with typed-bucket exception handling + `logger.warning`, tightening
the repo-wide budget from 89 toward ≤ 80.
